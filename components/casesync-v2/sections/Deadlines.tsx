...
const FIELDS: Array<{
  ...
  { field: 'spm_next_due',            label: 'SPM next due',        Icon: Calendar,   color: '#DB2777' },
  ...
  { field: 'co_financial_redet_date', label: 'CO financial redet.', Icon: Briefcase,  color: '#EA580C' },
  { field: 'co_app_date',             label: 'CO application',      Icon: Briefcase,  color: '#C026D3' },
