      ...
      <div ref={spot.ref} onMouseMove={spot.onMouseMove} style={{ marginBottom: 20 }}>
        <Paper radius="lg" p="xl" className="eva-hero">
          ...
          <div className="eva-hero-spotlight" aria-hidden />
            ...
            <img src="/heroes/evaluations.svg" alt="" aria-hidden="true" style={{ position: "absolute", right: "8%", top: "50%", transform: "translateY(-50%)", height: "75%", zIndex: 0, opacity: 0.45, pointerEvents: "none" }} />
