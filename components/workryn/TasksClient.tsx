  ...
  return (
    <>
      <Container size="xl" py="lg" w="100%" className="tka-root">
        ...
        {bannerUrl ? (
          <>
            <PageBanner bannerUrl={bannerUrl} anim={ANIM.gDueWeek} />
        ...
        <div ref={spot.ref} onMouseMove={spot.onMouseMove} style={{ marginBottom: 20 }}>
          <Paper radius="lg" p="xl" className="tka-hero">
            ...
            <img src="/heroes/tasks.svg" alt="" aria-hidden="true" style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)", height: "70%", zIndex: 0, opacity: 0.22, pointerEvents: "none" }} />
