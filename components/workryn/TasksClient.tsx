...
export default function TasksClient({ initialTasks, users, departments, currentUserId }: Props) {
  ...
  return (
    <div className="tk-page">
      ...
      <style>{`
.tk-page { position:relative; display:flex; flex-direction:column; gap:0; min-height:100%; }
...
.tk-hero-banner { position:relative; overflow:visible; display:block; margin-bottom:0; z-index:1; padding:24px 0 16px; box-sizing:border-box; background:linear-gradient(135deg, rgba(99,102,241,0.08) 0%, rgba(15,20,40,0.4) 50%, rgba(16,185,129,0.05) 100%); border-bottom:1px solid rgba(255,255,255,0.06); }
