    ...
    <div style={{ marginBottom: 28 }}>
      ...
      <div className="stat-hero-grid" style={{
        ...
        <HeroStatCard
          ...
          gradient={brightGradients ? "linear-gradient(135deg, #1E7CFF 0%, #2D8BFF 50%, #1A6FEB 100%)" : lt ? "linear-gradient(135deg, #2c3e6e 0%, #3a5090 50%, #2e4272 100%)" : "linear-gradient(135deg, #1a1c2e 0%, #2a2d4a 50%, #1e2040 100%)"}
          glowColor={brightGradients ? "#1E7CFF" : lt ? "#3a5090" : "#4a5080"}
        ...
        <HeroStatCard
          ...
          gradient={brightGradients ? "linear-gradient(135deg, #FF3B5C 0%, #FF5573 50%, #E63350 100%)" : lt ? "linear-gradient(135deg, #8b1a2b 0%, #b22840 50%, #921e30 100%)" : "linear-gradient(135deg, #3d1219 0%, #6b1d2a 50%, #4a1520 100%)"}
          glowColor="#ff453a"
        ...
        <HeroStatCard
          ...
          gradient={brightGradients ? "linear-gradient(135deg, #FFA940 0%, #FFB860 50%, #F59E0B 100%)" : lt ? "linear-gradient(135deg, #7a5520 0%, #9e6e2a 50%, #825a22 100%)" : "linear-gradient(135deg, #2d2210 0%, #4a3818 50%, #352a12 100%)"}
          glowColor={brightGradients ? "#ff9f0a" : lt ? "#b87800" : "#ff9f0a"}
        ...
        <HeroStatCard
          ...
          gradient={brightGradients ? "linear-gradient(135deg, #10B981 0%, #1AC78A 50%, #059669 100%)" : lt ? "linear-gradient(135deg, #6a6a20 0%, #8a8a30 50%, #707020 100%)" : "linear-gradient(135deg, #2a2a10 0%, #484818 50%, #363612 100%)"}
          glowColor={brightGradients ? "#10B981" : lt ? "#8a8a00" : "#ffd60a"}
