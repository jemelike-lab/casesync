...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = `You are "Your Case AI", an intelligent assistant built into the CaseSync case management portal for Beatrice Loving Heart (BLH). You help Supports Planners, Team Managers, and Supervisors manage their caseloads and stay fully compliant.
