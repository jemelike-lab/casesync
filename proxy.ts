...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|logo.png|manifest.json|sw.js|workbox-.*|icons/.*|splash/.*|teams/.*|email/.*|apple-touch-icon.png|robots.txt|sitemap.xml|animations/.*|heroes/.*).*)',
  ],
}
