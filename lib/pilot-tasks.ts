...
export const PILOT_GROUPS: PilotGroup[] = [
  {
    ...
    icon: '1',
    tasks: [
      { key: 'verify.roster', t: 'Open Clients \u2192 My Caseload. Is every client of yours here \u2014 and no one who isn\u2019t?', s: 'Find it: Clients in the top nav \u2192 My Caseload tab. Missing or extra clients are the single most important thing to catch this week.' },
      { key: 'verify.fields5', t: 'Pick 5 clients and check every field against your own records', s: 'Find it: click any client row to open their record. Check Client ID, eligibility code and end date, program (CFC vs CO).' },
      { key: 'verify.dates5', t: 'Check the dates that drive your work on those 5', s: 'Find them: the Deadlines card near the top of each client page \u2014 3-month visit, waiver, med-tech redet, POS deadline, assessment due, last contact.' },
      { key: 'verify.notes3', t: 'Open Notes on 3 clients \u2014 did your notes and contact attempts come through?', s: 'Find it: the Notes card near the bottom of the client page. Entries badged \u201cSmartsheet\u201d were imported automatically from your sheet.' },
    ],
  },
  {
    ...
    icon: '2',
    tasks: [
      { key: 'live.contact', t: 'Log a real contact right after you make one', s: 'Find it: the Log Contact button \u2014 on your Dashboard, in the Log Contact column on the Clients list, or on any client page.' },
      { key: 'live.deadline', t: 'Update a deadline after a visit', s: 'Find it: open the client and press Edit \u2014 every deadline date is editable there.' },
      { key: 'live.note', t: 'Add a note to a client record', s: 'Find it: the Notes card on the client page \u2014 type in the box and press Add note.' },
      { key: 'live.search10', t: 'Find a client by name using search \u2014 under 10 seconds?', s: 'Find it: the search box at the top of the Clients page \u2014 results filter as you type.' },
